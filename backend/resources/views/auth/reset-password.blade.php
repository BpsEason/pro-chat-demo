    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-10">
                ...
                <h2 class="text-3xl font-bold text-gray-900">設定新密碼</h2>
                <p class="mt-2 text-gray-600">請為您的帳號建立一個安全的新密碼</p>
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="email" class="block mt-2 w-full rounded-xl border-gray-300 focus:border-purple-500 focus:ring-purple-500 shadow-sm"
                            type="email"
                            name="email"
